  ...
  <div className="sidebar-card animate-in">
    <div className="p-4 text-center">
      ...
      <div className="d-flex justify-content-center gap-3 mb-3">
        <div>
          <div className="gradient-text fw-bold" style={{ fontSize: '1.3rem' }}>4+</div>
          <div className="text-muted" style={{ fontSize: '0.7rem' }}>Dự án</div>
        </div>
        <div className="vr opacity-25" />
        <div>
          <div className="gradient-text fw-bold" style={{ fontSize: '1.3rem' }}>4+</div>
          <div className="text-muted" style={{ fontSize: '0.7rem' }}>Công nghệ</div>
        </div>
      </div>
